...
public class ElasticSearchBatchSourceConfig implements Serializable {
    ...
    @FieldDoc(
        required = false,
        defaultValue = "",
        help = "The comma separated ordered list of field names used to build the Pulsar key from the record value. If this list is a singleton, the field is converted as a string. If this list has 2 or more fields, the generated key is a string representation of a JSON array of the field values."
    )
    ...
    @FieldDoc(
        required = false,
        defaultValue = "",
        help = "The index name from which the connector reads messages. The default value is the topic name."
    ...
    @FieldDoc(
        required = false,
        defaultValue = "_doc",
        help = "The type name that the connector reads messages from, with the default value set to _doc."
    ...
    @FieldDoc(
        required = false,
        defaultValue = "false",
        help = "Sets whether the BatchSource has to take into account the Schema or if it should simply copy the raw message from Elasticsearch"
    )
    ...
    public static ElasticSearchBatchSourceConfig load(Map<String, Object> map, SourceContext sourceContext) throws IOException {
