 ...
 * under the License.
 */
package org.apache.pulsar.io.elasticsearch.opensearchv2;
...
public class OpenSearch2ClientSslTests extends ElasticSearchTestBase {
    ...
    public OpenSearch2ClientSslTests() {
        super(OPENSEARCH_2);
    }
    ...
    public void testSslBasic() throws IOException {
        try (ElasticsearchContainer container = createElasticsearchContainer()
            ...
            ElasticSearchClient client = new ElasticSearchClient(config, mock(SourceContext.class));
